...
int ptest_list_destroy(void){
    ...
    ASSERT_FALSE(PLIST_DESTROY, list_destroy(&listobj).code);
    return 0;
}
...
int ptest_list_set(void){
    ...
    ASSERT_FALSE(PLIST_SET, list_set(&listobj, &element, 0).code);
...
int ptest_list_get(void){
    ...
    int32_t restored = 0;
    ASSERT_FALSE(PLIST_GET, list_get(&listobj, &restored, 0).code);
...
int ptest_list_add(void){
    ...
    ASSERT_FALSE(PLIST_ADD, list_add(&listobj, &tmp).code);
    ASSERT_FALSE(PLIST_ADD2, list_add(&listobj, &element).code);
...
int ptest_list_addrange1(void){
    ...
    ASSERT_EQ(PLIST_ADDRANGE, listobj.elementcount, 4);
...
int ptest_list_findindex1(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 123;
    ASSERT_EQ(PLIST_FINDINDEX1, list_findindex1(&listobj, 2, 5, pcomparer, &find).index, 4);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_findindex2(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 123;
    ASSERT_EQ(PLIST_FINDINDEX2, list_findindex2(&listobj, 4, pcomparer, &find).index, 4);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_findindex3(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 123;
    ASSERT_EQ(PLIST_FINDINDEX3, list_findindex3(&listobj, pcomparer, &find).index, 4);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_findlast(void){
    ...
    int32_t find = 8;
    int32_t restored = 0;
    ASSERT_FALSE(PLIST_FINDLAST, list_findlast(&listobj, &find, pcomparer, &restored).code);
...
int ptest_list_findlastindex1(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_FINDLASTINDEX1, list_findlastindex1(&listobj, 2, 6, pcomparer, &find).index, 5);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_findlastindex2(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_FINDLASTINDEX2, list_findlastindex2(&listobj, 2, pcomparer, &find).index, 5);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_findlastindex3(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_FINDLASTINDEX3, list_findlastindex3(&listobj, pcomparer, &find).index, 5);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_indexof1(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_INDEXOF1, list_indexof1(&listobj, &find, 2, 5).index, 3);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_indexof2(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_INDEXOF2, list_indexof2(&listobj, &find, 2).index, 3);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_indexof3(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_INDEXOF3, list_indexof3(&listobj, &find).index, 3);
    list_destroy(&listobj);
    return 0;
}
...
int ptest_list_insert(void){
    ...
    ASSERT_FALSE(PLIST_INSERT, list_insert(&listobj, &test_val, 2).code);
...
int ptest_list_lastindexof1(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_LASTINDEXOF1, list_lastindexof1(&listobj, &find, 4, 6).index, 5);
	list_destroy(&listobj);
    return 0;
}
...
int ptest_list_lastindexof2(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_LASTINDEXOF2, list_lastindexof2(&listobj, &find, 4).index, 5);
	list_destroy(&listobj);
    return 0;
}
...
int ptest_list_lastindexof3(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_EQ(PLIST_LASTINDEXOF3, list_lastindexof3(&listobj, &find).index, 5);
	list_destroy(&listobj);
    return 0;
}
...
int ptest_list_remove(void){
    ...
    int32_t arr[8] = {4, 7, 1, 5, 123, 5, 8675, 92478};
    list_addrange1(&listobj, &arr, 8);
    ASSERT_EQ(PLIST_REMOVE, listobj.elementcount, 8);
    int32_t find = 5;
    ASSERT_FALSE(PLIST_REMOVE, list_remove(&listobj, &find).code);
    int check = 0;
...
int ptest_list_removeall(void){
    ...
    list_addrange1(&listobj, &arr, 8);
    int32_t find = 5;
    ASSERT_FALSE(PLIST_REMOVEALL, list_removeall(&listobj, &find, pcomparer).code);
	list_destroy(&listobj);
	return 0;
}
...
int ptest_list_removeat(void){
    ...
    int32_t arr[8] = {4, 7, 1, 5, 123, 5, 8675, 92478};
    list_addrange1(&listobj, &arr, 8);
    ASSERT_FALSE(PLIST_REMOVEAT, list_removeat(&listobj, 3).code);
    int32_t check = 0;
    list_get(&listobj, &check, 3);
...
int ptest_list_reverse(void){
    ...
    list listobj = list_init(1, sizeof(int32_t));
    int32_t arr[8] = {4, 7, 1, 5, 123, 5, 8675, 92478};
    list_addrange1(&listobj, &arr, 8);
    ASSERT_FALSE(PLIST_REVERSE, list_reverse(&listobj).code);
    for (int i = 0; i < 8; i++){
        int check = 0;
...
int ntest_list_set(void){
	...
	int t = 5;
	ASSERT_EQ(NTEST_LIST_SET1, list_set((void*)0, &t, 0).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_SET2, list_set(&listobj, (void*)0, 0).code, NULLPTR);
...
int ntest_list_get(void){
	list listobj = list_init(1, sizeof(int));
	int restore;
	ASSERT_EQ(NTEST_LIST_GET1, list_get((void*)0, &restore, 0).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_GET2, list_get(&listobj, (void*)0, 0).code, NULLPTR);
...
int ntest_list_add(void){
	...
	list listobj;
	int t = 5;
	ASSERT_EQ(NTEST_LIST_ADD1, list_add((void*)0, &t).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_ADD2, list_add(&listobj, (void*)0).code, NULLPTR);
	return 0;
}
...
int ntest_list_findindex1(void){
    ...
    list listobj;
    int find = 5;
	ASSERT_EQ(NTEST_LIST_FINDINDEX1_1, list_findindex1(0, 0, 0, pcomparer, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX1_2, list_findindex1(&listobj, 0, 0, 0, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX1_3, list_findindex1(&listobj, 0, 0, pcomparer, 0).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX1_4, list_findindex1(&listobj, 5, 0, pcomparer, &find).code, ARGBADRANGE);
	ASSERT_EQ(NTEST_LIST_FINDINDEX1_5, list_findindex1(&listobj, 5, 8, pcomparer, &find).code, ARGBADRANGE);
	return 0;
}
...
int ntest_list_findindex2(void){
    ...
    list listobj;
    int find = 5;
	ASSERT_EQ(NTEST_LIST_FINDINDEX2_1, list_findindex2(0, 0, pcomparer, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX2_2, list_findindex2(&listobj, 0, 0, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX2_3, list_findindex2(&listobj, 0, pcomparer, 0).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX2_4, list_findindex2(&listobj, 5, pcomparer, &find).code, ARGBADRANGE);
	return 0;
}
...
int ntest_list_findindex3(void){
    ...
    list listobj;
    int find = 5;
	ASSERT_EQ(NTEST_LIST_FINDINDEX3_1, list_findindex3(0, pcomparer, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX3_2, list_findindex3(&listobj, 0, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDINDEX3_3, list_findindex3(&listobj, pcomparer, 0).code, NULLPTR);
	return 0;
}
...
int ntest_list_findlast(void){
	...
	list listobj;
	int find = 5, restore = 6;
	ASSERT_EQ(NTEST_LIST_FIND1, list_findlast(0, &find, pcomparer, &restore).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FIND2, list_findlast(&listobj, 0, pcomparer, &restore).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FIND3, list_findlast(&listobj, &find, 0, &restore).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FIND4, list_findlast(&listobj, &find, pcomparer, 0).code, NULLPTR);
	return 0;
}
...
int ntest_list_findlastindex1(void){
    ...
    list listobj;
    int find = 5;
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX1_1, list_findlastindex1(0, 0, 0, pcomparer, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX1_2, list_findlastindex1(&listobj, 0, 0, 0, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX1_3, list_findlastindex1(&listobj, 0, 0, pcomparer, 0).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX1_4, list_findlastindex1(&listobj, 5, 0, pcomparer, &find).code, ARGBADRANGE);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX1_5, list_findlastindex1(&listobj, 5, 8, pcomparer, &find).code, ARGBADRANGE);
	return 0;
}
...
int ntest_list_findlastindex2(void){
    ...
    list listobj;
    int find = 5;
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX2_1, list_findlastindex2(0, 0, pcomparer, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX2_2, list_findlastindex2(&listobj, 0, 0, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX2_3, list_findlastindex2(&listobj, 0, pcomparer, 0).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX2_4, list_findlastindex2(&listobj, 5, pcomparer, &find).code, ARGBADRANGE);
	return 0;
}
...
int ntest_list_findlastindex3(void){
    ...
    list listobj;
    int find = 5;
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX3_1, list_findlastindex3(0, pcomparer, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX3_2, list_findlastindex3(&listobj, 0, &find).code, NULLPTR);
	ASSERT_EQ(NTEST_LIST_FINDLASTINDEX3_3, list_findlastindex3(&listobj, pcomparer, 0).code, NULLPTR);
	return 0;
}
...
int ntest_list_foreach(void){
    SET_TEST_SUITE_NAME(LIST_FOREACH);
    list listobj = list_init(1, sizeof(int));
    ASSERT_EQ(NTEST_LIST_FOREACH1, list_foreach(0, paction).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_FOREACH2, list_foreach(&listobj, 0).code, NULLPTR);
    return 0;
}
...
int ntest_list_indexof1(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_INDEXOF1_1, list_indexof1(0, &item, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INDEXOF1_2, list_indexof1(&listobj, 0, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INDEXOF1_3, list_indexof1(&listobj, &item, 10, 5).code, ARGBADRANGE);
    ASSERT_EQ(NTEST_LIST_INDEXOF1_4, list_indexof1(&listobj, &item, 5, 10).code, ARGBADRANGE);
    return 0;
}
...
int ntest_list_indexof2(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_INDEXOF2_1, list_indexof2(0, &item, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INDEXOF2_2, list_indexof2(&listobj, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INDEXOF2_3, list_indexof2(&listobj, &item, 5).code, ARGBADRANGE);
    return 0;
}
...
int ntest_list_indexof3(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_INDEXOF3_1, list_indexof3(0, &item).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INDEXOF3_2, list_indexof3(&listobj, 0).code, NULLPTR);
    return 0;
}
...
int ntest_list_insert(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_INSERT1, list_insert(0, &item, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INSERT2, list_insert(&listobj, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_INSERT3, list_insert(&listobj, &item, 5).code, ARGBADRANGE);
    return 0;
}
...
int ntest_list_lastindexof1(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF1_1, list_lastindexof1(0, &item, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF1_2, list_lastindexof1(&listobj, 0, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF1_3, list_lastindexof1(&listobj, &item, 10, 5).code, ARGBADRANGE);
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF1_4, list_lastindexof1(&listobj, &item, 5, 10).code, ARGBADRANGE);
    return 0;
}
...
int ntest_list_lastindexof2(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF2_1, list_lastindexof2(0, &item, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF2_2, list_lastindexof2(&listobj, 0, 0).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF2_3, list_lastindexof2(&listobj, &item, 5).code, ARGBADRANGE);
    return 0;
}
...
int ntest_list_lastindexof3(void){
    ...
    list listobj;
    int item = 5;
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF3_1, list_lastindexof3(0, &item).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_LASTINDEXOF3_2, list_lastindexof3(&listobj, 0).code, NULLPTR);
    return 0;
}
...
int ntest_list_remove(void){
    ...
    list listobj = list_init(1, sizeof(int));
    int find = 5;
    ASSERT_EQ(NTEST_LIST_REMOVE1, list_remove(0, &find).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_REMOVE2, list_remove(&listobj, 0).code, NULLPTR);
    return 0;
}
...
int ntest_list_removeall(void){
    ...
    list listobj;
    int find = 5;
    ASSERT_EQ(NTEST_LIST_REMOVEALL1, list_removeall(0, &find, pcomparer).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_REMOVEALL2, list_removeall(&listobj, 0, pcomparer).code, NULLPTR);
    ASSERT_EQ(NTEST_LIST_REMOVEALL3, list_removeall(&listobj, &find, 0).code, NULLPTR);
    return 0;
}
...
int ntest_list_reverse(void){
    SET_TEST_SUITE_NAME(LIST_REVERSE);
    ASSERT_EQ(NTEST_LIST_REVERSE1, list_reverse(0).code, NULLPTR);
    return 0;
}
